...
class TestSwathProjector(TestCase):
    ...
    def test_single_band_input(self, mock_download, mock_stage, mock_datetime):
        ...
        mock_download.assert_called_once_with(
            input_file_path, ANY, logger=ANY, access_token=self.access_token, cfg=ANY
        )
        mock_stage.assert_called_once_with(
            StringContains('VNL2_oneBand_repr.nc'),
    ...
    def test_africa_input_with_history_and_history_json(
        self, mock_download, mock_stage, mock_datetime
    ):
    ...
    def test_africa_input_with_history_uppercase(
        self, mock_download, mock_stage, mock_datetime
    ):
    ...
    def test_single_band_input_default_crs(
        self, mock_download, mock_stage, mock_datetime
    ):
    ...
    def test_single_band_input_reprojected_metres(
        self, mock_download, mock_stage, mock_datetime
    ):
